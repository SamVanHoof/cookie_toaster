...
var CookieToasterModal = function (_React$Component) {
  _inherits(CookieToasterModal, _React$Component);

  function CookieToasterModal() {
    var _ref;

    var _temp, _this, _ret;

    _classCallCheck(this, CookieToasterModal);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = CookieToasterModal.__proto__ || Object.getPrototypeOf(CookieToasterModal)).call.apply(_ref, [this].concat(args))), _this), _this.state = { hidden: true }, _this.hide = function (accepted) {
  ...
  _createClass(CookieToasterModal, [{
      ...
      return _react2.default.createElement(
        ...
        !this.props.popped && _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            { className: 'cookie-toaster-modal' },
            _react2.default.createElement(
              'h1',
              null,
              this.props.title
  ...
  return CookieToasterModal;
}(_react2.default.Component);

CookieToasterModal.propTypes = {
...
CookieToasterModal.defaultProps = {
...
exports.default = CookieToasterModal;