...
var CookieToaster = function (_React$Component) {
  ...
  function CookieToaster() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = CookieToaster.__proto__ || Object.getPrototypeOf(CookieToaster)).call.apply(_ref, [this].concat(args))), _this), _this.state = { hidden: true }, _this.hide = function (accepted) {
